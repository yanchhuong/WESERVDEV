...
<script src="/js/product_control_001.js"></script>
<script>
$(function(){
	// Invoke the plugin
		...
		<div class="content">
			...
			<div class="content_wrap" style="padding: 24px 35px 11px 11px;">
				...
				<div class="title_wrap">
					<div class="left"><h1>Control Product</h1></div>
						...
						<tbody>
							<tr>
								<td><div>
									...
									<input type="text" style="width:70px;" id="regdate" placeholder="Register Date" class="">&nbsp;<a href="javascript:" id="img_date"><img src="../img/ico/ico_calendar.png" alt="달력"></a>
								</div></td>
								...
								<td><div>
									...
									<input type="text" id="keySRC" placeholder="owner ,title , page name" style="width:240px;">
									<span ><a href="javascript:"> Price </a></span>
									<input type="text" id="sPrice" placeholder="Min Price" style="width:100px;"> ~
									<input type="text" id="ePrice" placeholder="Max Price" style="width:100px;">
									<span class="btn_search_tb"><a href="javascript:">Find</a></span>
								</div></td>
							</tr>
						</tbody>
					</table>
					...
					<table class="tbl_result">
						...
						<thead>
							<tr>
								...
								<th scope="col"><div>Price</div></th>
								<th scope="col"><div>Post Date</div></th>
								<th scope="col"><div>Page Name</div></th>
								<th scope="col"><div>Owner</div></th>
								<th scope="col"><div>Product Type</div></th>
								<th scope="col"><div>View Count</div></th>
								<th scope="col"><div>Like Count</div></th>
