	...
	$.ajax({
	    ...
	    success: (function(dat){
	    	...
	    	$.each(dat.OUT_REC, function(i,v){
	    		var j = i + 1;
	    		if(v.lvl == "1"){
	    			html += '<a href="javascript:" class="ctg_0'+j+'" catg-id="'+v.catgid+'" style="background-image:url('+"https://storage.googleapis.com/g9bay-file/"+v.randname+');background-size:20px;background-position:10px;">'+v.nm_eng+'</a>';
	    		}
	    	});
    	...
    	$(".pagination").pagination({
    	    ...
    	    callback: function(data, pagination) {
    	    	...
    	    	$.each(data, function(i,v){
    			    ...
    			    html += 		'<img src="https://storage.googleapis.com/g9bay-file/'+v.randname+'" alt="first_product" class="thumb loaded">';
    ...
    $.ajax({
		...
		success : function(data){
			...
			$.each(data.OUT_REC, function(i, v){
				$("#sidebar_photo").attr("src","https://storage.googleapis.com/g9bay-file/"+v.randname);
