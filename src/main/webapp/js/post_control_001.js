...
post_control_001.uploadFormData = function(file){
	...
	$.ajax({
	    ...
	    success: function(data){
	    	...
	    	wrap_img.append($('<img width="200px" height="140px" value="'+"https://storage.googleapis.com/g9bay-file/"+'" style="margin:6px;">').attr("src","https://storage.googleapis.com/g9bay-file/"+ data.RANDNAME));
