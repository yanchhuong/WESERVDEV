...
post_control_001.uploadFormData = function(file){
	...
	$.ajax({
	    ...
	    success: function(data){
	    	...
	    	wrap_img.append($('<img width="200px" height="140px" value="'+"https://s3-us-west-1.amazonaws.com/g9bay-image-files/"+'" style="margin:6px;">').attr("src", document.location.origin+"/upload_file/files/"+ data.RANDNAME));
