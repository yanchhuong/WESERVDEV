    ...
    $.ajax({
		  ...
		  success: function(data){
			  ...
			  $.each(data.PICTURE_REC, function(i,v){
				  html += '<li data-thumb="'+"https://s3-us-west-1.amazonaws.com/g9bay-image-files/"+v.randname+'"><img src="'+document.location.origin+"/upload_file/files/"+v.randname+'" alt="productPicture"></li>';
			  });
