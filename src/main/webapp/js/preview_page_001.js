...
preview_page_001.loadCategory = function(){
	...
	.done(function(dat){
    	...
    	$.each(dat.OUT_REC, function(i,v){
    		var j = i + 1;
    		if(v.lvl == "1"){
    			html += '<a href="#none" class="ctg_0'+j+'" catg-id="'+v.catgid+'" style="background-image:url('+"https://storage.googleapis.com/g9bay-file/"+v.randname+');background-size:20px;background-position:10px;">'+v.nm_eng+'</a>';
    		}
    	});
    ...
    $.ajax({
		...
		success : function(data){
			...
			$.each(data.OUT_REC, function(i, v){
				strPrf += '<img src="'+"https://storage.googleapis.com/g9bay-file/"+v.randname+'" alt="" class="loaded">';
			});
    ...
    $.ajax({
		  ...
		  success: function(data){
			  ...
			  $.each(data.PICTURE_REC, function(i,v){
				  html += '<li data-thumb="'+"https://storage.googleapis.com/g9bay-file/"+v.randname+'"><img src="'+"https://storage.googleapis.com/g9bay-file/"+v.randname+'" alt="productPicture"></li>';
			  });
		    	    ...
		    	    callback: function(data, pagination) {
					  ...
					  $.each(data, function(i, v){
						 ...
						 if(v.randname == null){
						  ...
						  html +=		'<div class="customer"><img src="'+"https://storage.googleapis.com/g9bay-file/"+v.randname+'" alt=""></div>';
						 }
						  html +=		'<div>';
  			 ...
  			 if(data.OUT_REC.length > 0 || data.OUT_REC == null){
  	  			 $.each(data.OUT_REC, function(i, v){
  					  ...
  					  item3 += '<div class="col-xs-6 col-sm-4" id="relPro"> '
  				            ...
  				            + '            <a href="#"><img src="'+"https://storage.googleapis.com/g9bay-file/"+v.randname+'" class="img-responsive" alt="a" /></a> '
  				            + '        </div> '
